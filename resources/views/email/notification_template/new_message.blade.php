                ...
                <tr>
                    <td style="width:100%; text-align:left; background-color:#fff; padding:26px 30px 23px 30px;">
                        <table style="color:#000; font-size:16px; line-height:1.5; width:100%; background-color:#fff; border-collapse: collapse; margin:0; padding:0;"
                            ...
                            <tr>
                                <td class="main-data">
                                    <h3 style="font-size:20px; font-weight:700; margin:0 0 4px 0; padding:0;">
                                        @lang('v.hello')</h3>
                    ...
                    <tr>
                        <td style="width:100%; text-align:left; padding:10px 0 0 0;">
                            <table style="color:#000;
                                                        ...
                                                        margin:0;
                                                        padding:0;" width="100%" border="0" cellspacing="0"
                                   cellpadding="0">
                                <tbody>
                                <tr>
                                    <td style="width:100%; text-align:left; background-color:#fff; padding:20px 60px 20px 60px;">
                                        <h4 style="font-size:17px; font-weight:700; color:#0363cd; margin:0; padding:0;">
                                            @lang('v.review') #{{$key}}</h4>
                                            ...
                                            <table style="color:#000;
                                                ...
                                                <tr>
                                                    <td style="width:100%;
                                                        ...
                                                        <p style="margin:0; padding:0; font-size:16px; font-weight: 500;">{{$autoservice[$auto->sender_id]['name']}}</p>

                                                        <p style="margin:0; padding:0; color: #696969;"> {{$autoservice[$auto->sender_id]['city_ro']}}
                                                            , {{$autoservice[$auto->sender_id]['address']}}</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:100%;
                                                        ...
                                                        <p style="margin:0; padding:0;">{{$auto->message}}</p>

                                                        <p style="margin:16px 0 0 0; padding:0;"><a class="btn-confirm"
                                                                                                    ...
                                                                                                    title="@lang('v.response')">@lang('v.response')</a>
                                                        </p>
                                                        <?php $dt = new \DateTime($auto->created_at);?>
