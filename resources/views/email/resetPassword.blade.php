                        ...
                        <table style="color:#000; font-size:16px; line-height:1.5; width:100%; background-color:#fff; border-collapse: collapse; margin:0; padding:0;"
                            ...
                            <tr>
                                <td class="main-data">
                                    ...
                                    <p style="margin:0; padding:0;">@lang('v.request_new_password') <a
                                                style="color:#0363cd;"
                                                href="{{URL::route('reset_password_str',$token)}}">@lang('v.go_to_link')</a> @lang('v.click_btn_2')
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align:center; padding:18px 0 1px 0;">
                                    <a class="btn-confirm" style="display:inline-block;
                                       ...
                                       href="{{URL::route('reset_password_str',$token)}}">@lang('v.enter_new_passord')</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
