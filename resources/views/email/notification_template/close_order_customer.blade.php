...
<table style="font-size:100%; font-family:Roboto, Helvetica, sans-serif; width:100%; height:100%; background-color:#f2f2f2; color:#000000; border-collapse:collapse; margin:0; padding:0;" align="center" border="0" width="100%" cellpadding="0" cellspacing="0">
    <tbody>
    <tr>
        <td align="center" style="width:100%; text-align:center; padding:10px 20px 20px 20px; vertical-align:top;" width="100%">
            <table style="max-width:680px; margin:0 auto; background-color:#f2f2f2; border-collapse:collapse; padding:0;" width="680" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                <tr>
                    <td style="width:100%; height:107px; text-align:center; margin:0; padding:0;" width="100%">
                ...
                <tr>
                    <td style="width:100%; text-align:left; background-color:#fff; padding:26px 30px 25px 30px;" width="100%">
                        <table style="color:#000; font-size:16px; line-height:1.5; width:100%; background-color:#fff; border-collapse: collapse; margin:0; padding:0;" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tbody>
                            <tr>
                                <td class="main-data" width="100%">
                                    <h3 style="font-size:20px; font-weight:700; margin:0 0 4px 0; padding:0;">@lang('v.hello')</h3>
                                    <p style="margin:0; padding:0;">@lang('v.autoserver_close') <strong>#{{$detail['order_id']}}.</strong></p>
                                    <?php
                                    ...
                                    <p style="margin:0; padding:0;">@lang('v.from_view') <a style="color:#0363cd;" href="{{URL::route('dashboard')}}?orders={{$detail['order_id']}}" title="@lang('v.go_to_order')">@lang('v.go_to_link')</a> @lang('v.page_down')</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align:center; padding:11px 0 33px 0;" width="100%">
                                    <a class="btn-confirm" style="display:inline-block;
                                                            ...
                                                            color:#fff;
                                                            background-color:#e30613;" href="{{URL::route('dashboard')}}?orders={{$detail['order_id']}}" title="@lang('v.go_to_order')">@lang('v.go_to_order')</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                    <td style="font-size:13px; line-height:1.5; color:#808080; text-align:center; padding:16px 50px 31px 50px;" width="100%">
